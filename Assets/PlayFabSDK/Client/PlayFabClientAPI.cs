...
namespace PlayFab
{
    ...
    public static class PlayFabClientAPI
    {
        ...
        public static void LoginWithAndroidDeviceID(LoginWithAndroidIDRequest loginWithAndroidIDRequest, Action<LoginResult> p1, Action<PlayFabError> p2)
        {
        ...
        /// </summary>
        public static void LoginWithCustomID(LoginWithAndroidIDRequest request, Action<LoginResult> resultCallback, Action<PlayFabError> errorCallback, object customData = null, Dictionary<string, string> extraHeaders = null)
        {
            var context = (request == null ? null : request.AuthenticationContext) ?? PlayFabSettings.staticPlayer;
            var callSettings = PlayFabSettings.staticSettings;
            request.TitleId = request.TitleId ?? callSettings.TitleId;
